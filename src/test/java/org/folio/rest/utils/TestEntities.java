...
public enum TestEntities {
  ...
  FISCAL_YEAR(HelperUtils.getEndpoint(FinanceStorageFiscalYears.class), FiscalYear.class, "data/fiscal-years-8.4.0/", "fy26.json", "name", "FY26", 8, true),
  ...
  BUDGET(HelperUtils.getEndpoint(FinanceStorageBudgets.class), Budget.class, "data/budgets-8.4.0/", "AFRICAHIST-FY26.json", "name", "AFRICAHIST-FY26", 24, true),
  ...
  GROUP_FUND_FY(HelperUtils.getEndpoint(FinanceStorageGroupFundFiscalYears.class), GroupFundFiscalYear.class, "data/group-fund-fiscal-years-8.4.0/", "AFRICAHIST-FY26.json", "fundId", "7fbd5d84-62d1-44c6-9c45-6cb173998bbd", 13, true),
  ...
  SETTINGS(HelperUtils.getEndpoint(FinanceStorageSettings.class), Setting.class, "data/settings/", "enable-browse-tab.json", "value", "false", 0, true);
