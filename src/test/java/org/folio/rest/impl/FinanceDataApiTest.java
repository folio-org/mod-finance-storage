...
import static org.folio.rest.utils.TestEntities.FINANCE_DATA;
...
class FinanceDataApiTest extends TestBase {
  ...
  public void positive_testGetQuery() {
    verifyCollectionQuantity(FINANCE_DATA.getEndpoint() + "?query=(fiscalYearId==7a4c4d30-3b63-4102-8e2d-3ee5792d7d02)", 21, TENANT_HEADER);
    verifyCollectionQuantity(FINANCE_DATA.getEndpoint() + "?query=(fiscalYearId==9b1d00d1-1f3d-4f1c-8e4b-0f1e3b7b1b1b)", 0, TENANT_HEADER);
  }

  @Test
  public void positive_testResponseOfGet() {
    var response = getData(FINANCE_DATA.getEndpoint() + "?query=(fiscalYearId==7a4c4d30-3b63-4102-8e2d-3ee5792d7d02)", TENANT_HEADER);
