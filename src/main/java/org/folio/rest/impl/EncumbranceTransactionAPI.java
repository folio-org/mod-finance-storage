...
import org.folio.rest.jaxrs.model.EncumbranceTransaction;
import org.folio.rest.jaxrs.model.EncumbranceTransactionCollection;
...
public class EncumbranceTransactionAPI implements FinanceStorageEncumbrances {

  private static final String ENCUMBRANCE_TABLE = "transaction";
  ...
  public void getFinanceStorageEncumbrances(String query, int offset, int limit, String lang, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.get(ENCUMBRANCE_TABLE, EncumbranceTransaction.class, EncumbranceTransactionCollection.class, query, offset, limit, okapiHeaders, vertxContext,
      GetFinanceStorageEncumbrancesResponse.class, asyncResultHandler);
  }

  @Override
  @Validate
  public void postFinanceStorageEncumbrances(String lang, EncumbranceTransaction entity, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  public void getFinanceStorageEncumbrancesById(String id, String lang, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.getById(ENCUMBRANCE_TABLE, EncumbranceTransaction.class, id, okapiHeaders, vertxContext, GetFinanceStorageEncumbrancesByIdResponse.class, asyncResultHandler);
  }
  ...
  @Override
  @Validate
  public void putFinanceStorageEncumbrancesById(String id, String lang, EncumbranceTransaction entity, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
