...
public class LedgerRolloverProgressAPI implements FinanceStorageLedgerRolloversProgress {
  ...
  @Override
  @Validate
  public void getFinanceStorageLedgerRolloversProgress(String query, String totalRecords, int offset, int limit, Map<String, String> okapiHeaders,
  ...
  @Override
  @Validate
  public void postFinanceStorageLedgerRolloversProgress(LedgerFiscalYearRolloverProgress entity, Map<String, String> okapiHeaders,
             Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void getFinanceStorageLedgerRolloversProgressById(String id, Map<String, String> okapiHeaders,
              Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void deleteFinanceStorageLedgerRolloversProgressById(String id, Map<String, String> okapiHeaders,
              Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void putFinanceStorageLedgerRolloversProgressById(String id, LedgerFiscalYearRolloverProgress entity,
